 ...
 */
public class ProcessViewer implements ActionListener
{
   ...
   */
  public ProcessViewer() throws ClassNotFoundException
  {
    fileDialog();
    if(recipe!=null) init();
  }
  ...
  public void fileDialog() throws ClassNotFoundException
  {
    ...
    FileNameExtensionFilter rcpfilter = new FileNameExtensionFilter("Recipe Files", "rcp");
    fileChooser.setAcceptAllFileFilterUsed(false);
    fileChooser.addChoosableFileFilter(rcpfilter);
  ...
  {
    frame = new JFrame();
    frame.setTitle("KilowBites Process Viewer \t" + recipe.getName());
    ...
    utensils= new JTextArea(recipe.printAllUtensils());
    ...
    steps= new JTextArea(recipe.printSteps()); // PROBLEM 
...
//        //prevents suer from typing invalid numbers of hours and minutes
  ...
  public void actionPerformed(final ActionEvent e)
  {
    ...
    else if(e.getActionCommand().equals(CALCULATE))
    {
      ...
      recipe.setStartTime(startTime);
      System.out.println("made calculations");
      steps.setText(recipe.printStepsStartTime(startTime));
